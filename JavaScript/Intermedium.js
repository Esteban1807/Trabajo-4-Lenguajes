...
// Esta clase es para las llantas intermedias (Intermedium)
export default class Intermedium extends Tyres {
  ...
  Durability(laps) {
    if (laps > this.durabilityMax) {
      ...
      return (
        ...
        `The Intermediums are being changed`
      );
    }
    return `the tyres have been on track ${laps} laps\nCan continue`;
  }

  // Presión recomendada para Intermedium
  PSI() {
